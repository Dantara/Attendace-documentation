...
* Change Log
  + Added list of enrolled classes in "Current user" request.
  + Added "User classes" request (see "User specific requests" section).
  + Added "Class students" request (see "Classes" section).
* Roles
